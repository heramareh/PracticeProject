...
class TestDemo(unittest.TestCase):
    ...
    def test_openFireBug(self):
        # 找到自定义配置文件路径
        profilePath = r"C:\Users\Peany\AppData\Roaming\Mozilla\Firefox\Profiles\end5m0o5.default"
        ...
        driver = webdriver.Firefox(executable_path="d:\\geckodriver", firefox_profile = profile)
        # 等待浏览器启动完成
        time.sleep(3)
        # 找到百度主页中的搜索输入框页面元素
